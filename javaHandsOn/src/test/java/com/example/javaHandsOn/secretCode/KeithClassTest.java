package com.example.javaHandsOn.secretCode;
...
import com.example.javaHandsOn.secretCode.com.fresco.KeithClass;
...
public class KeithClassTest {
    ...
    @Test
    public void checkKeith(){
        NumberFinder finder = new NumberFinder();
        assertTrue(finder.checkKeith(28));
        assertTrue(finder.checkKeith(75));
        assertTrue(finder.checkKeith(197));
        assertFalse(finder.checkKeith(20));
    }

    @Test
    public void checkKeithComposite(){
        NumberFinder finder = new NumberFinder();
        assertTrue(finder.checkKeithComposite(28));
        assertTrue(finder.checkKeithComposite(75));
        assertFalse(finder.checkKeithComposite(19));
    }

    @Test
    public void getNumbers(){
        ExtractString extract = new ExtractString();
        assertNotNull(extract.getIntFromString("A: Hello, may I speak to Alice 14 please?  four B: This is she. How's it 19 going? A: I've been trying to call you 28 times all day B: Sorry about that. I was cleaning up 47. A: It's okay 61. B: So what were you calling 75 me about? A: Oh, I just wanted to see if you wanted to hang out 197 tomorrow. B: Sure, what did you want to do? A: Maybe we can go see a movie or something. B: That sounds like fun. Let's do it. A: I'll see you 7ytr4fhh6 tomorrow then. five B: See you then. Goodbye."));
    }

    @Test
    public void getNumbersFromWords(){
        ExtractString extract = new ExtractString();
        assertEquals(extract.getSumOfStringIntegers("A: Hello, may I speak to Alice 14 please?  four B: This is she. How's it 19 going? A: I've been trying to call you 28 times all day B: Sorry about that. I was cleaning up 47. A: It's okay 61. B: So what were you calling 75 me about? A: Oh, I just wanted to see if you wanted to hang out 197 tomorrow. B: Sure, what did you want to do? A: Maybe we can go see a movie or something. B: That sounds like fun. Let's do it. A: I'll see you 7ytr4fhh6 tomorrow then. five B: See you then. Goodbye."),9);
    }
